...
export default function Index({ auth, contents }) {
  const [confirmingCategoryDeletion, confirmingCategoryDelete] = useState(false);
    ...
    const deleteCategory = (e) => {
        preserveScroll: true
        destroy(route('contents.delete', {content: contentId.value}), {
            preserveScroll: true,
                                                ...
                                                { contents && contents.map( (content) => (
                                                    <tr key={content.id}>
                                                        ...
                                                        <td className="py-4 px-6 whitespace-nowrap">
                                                            {/* Start Actions */}
                                                            {/* Start Edit User */}
                                                            <Link href={route('categories.edit', {content: content.id})}
            ...
            <Modal show={confirmingCategoryDeletion} onClose={closeModal}>
                <div className="p-6">
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <DangerButton className="ms-3" disabled={processing} onClick={() => deleteCategory(contentId)}>
                            Excluir categoria
                        </DangerButton>
                    </div>
                </div>
